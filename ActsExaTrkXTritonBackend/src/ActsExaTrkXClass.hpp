...
class ActsExaTrkXClass {
 ...
 public:
  ActsExaTrkXClass(const std::string& modelDir, int deviceID, int logLevel);
  ~ActsExaTrkXClass();
...
ActsExaTrkXClass::ActsExaTrkXClass(
...
void
ActsExaTrkXClass::initializePipeline()
{
